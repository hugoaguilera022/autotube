...
app.post('/api/ai/production-plan',async(req,res)=>{try{
  ...
  const userPayload={
    task:'Crear el plan de escenas del vídeo nuevo manteniendo el tema y las instrucciones del usuario, pero con contenido original.',
